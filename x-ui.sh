...
update() {
    ...
    cd ~
    wget -N --no-check-certificate -O x-ui-install.sh https://raw.githubusercontent.com/Ryanjin212/x-ui-freebsd/main/install.sh
...
update_shell() {
    wget -O ~/x-ui.sh -N --no-check-certificate https://raw.githubusercontent.com/Ryanjin212/x-ui-freebsd/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
